...
const Addques=()=>{
    const[quesId] =useState()
    const[title,settitle] =useState("")
    const[opt1,set1] =useState("")
    const[opt2,set2] =useState("")
    const[op3,set3] =useState("")
            ...
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <div class="d-flex flex-row align-items-center mb-4">
                  ...
                  <button className="btn btn-primary" onClick={submit}>Save</button><button  className="btn btn-primary"onClick={()=>nav("/admin/questionpage",{state:{Token : token}})}>Cancel</button>
                  </div>
